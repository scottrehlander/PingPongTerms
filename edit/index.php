<?php
    ...
    $tblDemo = new ajaxCRUD("Item", "pingPongTerms", "termId", "./");
    ...
    $tblDemo->displayAs("termName", "Term Name");
    $tblDemo->displayAs("termDefinition", "Term Definition");
	$tblDemo->displayAs("termAdded", "Term Added Date");

	#set the textarea height of the longer field (for editing/adding)
    #http://ajaxcrud.com/api/index.php?id=setTextareaHeight
    $tblDemo->setTextareaHeight('termDefinition', 200);

    #i could omit a field if I wanted
    #http://ajaxcrud.com/api/index.php?id=omitField
    //$tblDemo->omitField("termCategoryId");

    #i could omit a field from being on the add form if I wanted
    $tblDemo->omitAddField("termAdded");
	//$tblDemo->omitAddField("termCategoryId");
    ...
    $tblDemo->addAjaxFilterBox('termName');
